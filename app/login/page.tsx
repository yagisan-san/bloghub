    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-2xl p-8 border border-[#e4e7f5]"
          ...
          <h2 className="text-lg font-bold text-[#1e2340] mb-6">ログイン</h2>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <p className="text-center">
              <Link href="/forgot-password" className="text-xs text-[#9ca3af] hover:text-[#5b7cf7] transition-colors">
                パスワードを忘れた方はこちら
              </Link>
            </p>
          </form>
        ...
        <p className="text-center text-sm text-[#6b7280] mt-4">
          アカウントをお持ちでない方は{' '}
          <Link href="/signup" className="text-[#5b7cf7] font-semibold hover:underline">
            新規登録
          </Link>
        </p>
      </div>
